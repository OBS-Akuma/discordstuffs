...
ws.onmessage = ({ data }) => {
  ...
  if (t === "MESSAGE_CREATE" && d.author.id === userId) {
    ...
    const commands = {
      "-gb": { reply: "August duh", deleteReply: false },
      "-k": { reply: "[#Y2OOB2](<https://kirka.io/profile/Y2OOB2>) (Banned), [#NUGGET](<https://kirka.io/profile/Y0N8B5>) (User), [#985CBJ](<https://kirka.io/profile/985CBJ>) (User + first account)", deleteReply: false },
      ...
      "-p": { reply: "that's my pookie!", deleteReply: false },
      "-d": { reply: "This message will self-delete immediately!", deleteReply: true },
      "-code": { reply: "https://github.com/OBS-Akuma/discordstuffs/", deleteReply: false }
    };
